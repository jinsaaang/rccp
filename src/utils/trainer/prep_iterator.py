...
class ManyToOneIterator:
    ...
    def __init__(self, datasets, seq_len, split_func, include_target_history=True, **kwargs):
        self._datasets = datasets
        self._feature_key = "x"
        self._target_key = "y"
        self._seq_len = seq_len
        self._split_func = split_func
        self._include_target_history = include_target_history
    ...
    def dataset_to_sequences(self, dataset):
        ...
        if self._include_target_history:
