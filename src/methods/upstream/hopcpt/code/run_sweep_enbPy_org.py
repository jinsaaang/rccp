...
@hydra.main(version_base=None, config_path='./../configuration', config_name='default_enbPI_org.yaml')
def run(cfg: DictConfig):
    ...
    script_path = f'{cfg.config.experiment_data.base_proj_dir}code/main_enbPy.py'
