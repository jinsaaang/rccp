...
from models.uncertainty.components.quantile_forest import QuantileRegressionForestCompat
...
class SPICModel(PIModel):
    ...
    def _train_eps_regressor(self, ts_id, X_past, Y_past, X_reg_train, Y_reg_train, alpha, step_offset, eps_reg_train=None):
        self.model = QuantileRegressionForestCompat(**self._regressor_param)
