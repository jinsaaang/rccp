...
Official implementation of the [CIKM 2026](https://cikm2026.diag.uniroma1.it/) ![Italy](https://flagcdn.com/w20/it.png) paper **Retrieval-Corrected Conformal Prediction for Time Series**. This package contains the code, configurations, source data, checkpoints, and processed figure values needed to reproduce the main alpha 0.1 analysis from the paper.
