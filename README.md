...
Official implementation of **Retrieval-Corrected Conformal Prediction**. This package contains the code, configurations, source data, checkpoints, and processed figure values needed to reproduce the main alpha 0.1 analysis from the paper.
